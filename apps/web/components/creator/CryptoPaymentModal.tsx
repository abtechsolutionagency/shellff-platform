...
export function CryptoPaymentModal({
  ...
  const stopTimeCountdown = useCallback(() => {
  ...
  }, [paymentData.expiresAt, stopTimeCountdown]);
  ...
  }, [isOpen, paymentStatus, startStatusPolling, startTimeCountdown, stopStatusPolling, stopTimeCountdown]);
  ...
  }, [onPaymentComplete, paymentData.batchId, paymentStatus, stopStatusPolling]);
            ...
            <Card>
              <CardContent className="p-4 flex flex-col items-center gap-3">
                ...
                <Image
                  ...
                  alt={!paymentData.network ? 'Payment QR code' : `${paymentData.network} payment QR code`}
                  width={160}
                  height={160}
                  unoptimized
                  className="h-40 w-40 rounded-lg border border-muted bg-white p-2"
                />
              </CardContent>
            </Card>
          )}
