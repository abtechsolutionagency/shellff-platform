...
import { Bell, Users, Gift, X } from 'lucide-react'
  ...
  const dismissNotification = async (notificationId: string) => {
    try {
      ...
      if (response.ok) {
        ...
        void loadNotifications() // Refresh to get updated unread count
      }
    } catch (error) {
  ...
  const handleNotificationAction = async (notification: GroupNotification) => {
    ...
    switch (notification.type) {
      ...
      case 'member_joined':
        ...
        break
      case 'pack_expiring':
        toast.warning('Don&rsquo;t forget to complete your group pack!')
        break
    }
  }
