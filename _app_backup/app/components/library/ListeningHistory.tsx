...
import { Clock, Calendar, Smartphone, TrendingUp, Filter, Download, BarChart3 } from 'lucide-react';
...
export function ListeningHistory() {
  const { library, getListeningHistory, getRecentPlays } = usePersonalLibrary();
          ...
          <Card className="bg-shellff-accent border-shellff-accent">
            <CardHeader>
              ...
              <CardDescription className="text-shellff-neutral font-inter">
                Tracks you've listened to recently, ordered by last played
              </CardDescription>
            </CardHeader>
            <CardContent>
