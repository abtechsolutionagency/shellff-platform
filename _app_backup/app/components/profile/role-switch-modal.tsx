...
import { ArrowRight, Loader2, Music, User, Crown, Headphones, Shield } from 'lucide-react';
...
export function RoleSwitchModal({ currentRole, username, sciId, isRoleRestricted = false }: RoleSwitchModalProps) {
