            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <ul className="text-gray-300 text-sm space-y-1 ml-4">
                  <li>• Look inside your CD case or vinyl sleeve</li>
                  <li>• Check the back of your USB packaging</li>
                  <li>• Codes are printed on small cards or stickers</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  Codes follow the format: <code className="bg-gray-800 px-2 py-1 rounded text-[#00F5D4]">SH1234</code>
                </p>
              </div>
