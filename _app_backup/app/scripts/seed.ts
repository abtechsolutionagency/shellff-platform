...
async function main() {
  ...
  console.log('🎫 Creating unlock code pricing tiers...');
  ...
  console.log('🎵 Creating sample releases and unlock codes...');
  ...
  const sampleCodes = [
    { code: 'SH1234', releaseId: sampleRelease.id },
    { code: 'SH5678', releaseId: sampleRelease.id },
    { code: 'SH9012', releaseId: sampleRelease.id },
  ];
